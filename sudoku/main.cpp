...
int main() {
    float dt, timer;
        // timer for button
    Clock clock1;
    SudokuEngine sudoku(40,WINDOW_WIDTH);
    RenderWindow window(VideoMode(WINDOW_WIDTH, WINDOW_SIZE), "Sudoku", Style::Close);
    Buttons button(410,900,80,40,"Pixel_NES.otf","Check", Color::Black, Color(187,176,176,50),
